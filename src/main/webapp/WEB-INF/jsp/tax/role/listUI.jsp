...
<head>
    ...
    <script type="text/javascript">
        ...
        //新增
        function doAdd(){
            document.forms[0].action = "${basePath}role_addUI.do";
            document.forms[0].submit();
        }
        //编辑
        function doEdit(id){
            document.forms[0].action = "${basePath}role_editUI.do?role.roleId=" + id;
            document.forms[0].submit();
        }
        //删除
        function doDelete(id){
            document.forms[0].action = "${basePath}role_delete.do?role.roleId=" + id;
            document.forms[0].submit();
        }
        //批量删除
        function doDeleteAll(){
            document.forms[0].action = "${basePath}role_deleteSelected.do";
            document.forms[0].submit();
        }
